...
module nios_mm_interconnect_1_router_default_decode
  #(
...
module nios_mm_interconnect_1_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    nios_mm_interconnect_1_router_default_decode the_default_decode(
