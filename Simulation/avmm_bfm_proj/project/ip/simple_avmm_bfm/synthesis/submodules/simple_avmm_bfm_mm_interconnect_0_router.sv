...
module simple_avmm_bfm_mm_interconnect_0_router_default_decode
  #(
...
module simple_avmm_bfm_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    simple_avmm_bfm_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x1010 .. 0x1020 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 13'h1010   ) begin
            src_channel = 4'b0100;
